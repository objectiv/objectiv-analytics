...
compound models with little effort. The open model hub is powered by 
[Bach](https://objectiv.io/docs/modeling/bach/), our python-based modeling library.
...
### Your own code
To use the model hub in your own code, you can import the package and use it to get a 
[Bach](https://www.objectiv.io/docs/modeling/bach/) DataFrame to perform your operations on. The object can 
be instantiated as follows, where the `db_url` and `table_name`should be adjusted depending on where the data 
